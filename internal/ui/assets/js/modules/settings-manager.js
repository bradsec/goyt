...
export class SettingsManager {
    ...
    async handleSettingsSubmit(event) {
        ...
        try {
            ...
            if (portChanged) {
                this.uiManager.showNotification('Port change requires restart to take effect', 'warning', 10000);
            }
    ...
    async checkForUpdates() {
        try {
            ...
            if (updateInfo.update_available) {
                this.uiManager.showNotification(`yt-dlp update available: ${updateInfo.current_version} → ${updateInfo.latest_version}`, 'info', 10000);
